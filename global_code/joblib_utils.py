...
def remove_computation(func,*args, **kwds):
    hashdir,hash = func.get_output_dir(*args, **kwds)
    print 'Warning: Removing %s, %s, %s' %(func, repr(args), repr(kwds))
    print 'Removing %s' %(hashdir)
    os.system('rm -r %s '%(hashdir))
...
if __name__=='__main__':
    ...
    #def remove_computation(func,*args, **kwds):
    #    hashdir = cache_hash(func, *args, **kwds)
    #    os.system(
